...
function updateTotalMembers() {
  ...
  const sleepOver1 =
    parseInt(document.getElementById("sleepOver1").value, 10) || 0;

  const vacation2 =
    parseInt(document.getElementById("vacation2").value, 10) || 0;
  const sleepOver2 =
    parseInt(document.getElementById("sleepOver2").value, 10) || 0;
  ...
  const dorm1Current = dorm1Total - vacation1 - sleepOver1;
  document.getElementById("dorm1Current").value = dorm1Current;

  const dorm2Current = dorm2Total - sleepOver2 - vacation2;
...
function generateAndCopyText() {
  ...
  2. 열외 : ${document.getElementById("exceptions").value}명
      가. 1생활관 : 휴가 ${
        document.getElementById("vacation1").value
      }명, 외박 ${document.getElementById("sleepOver1").value}명
      나. 2생활관 : 휴가 ${
        document.getElementById("vacation2").value
      }명, 외박 ${document.getElementById("sleepOver2").value}명
